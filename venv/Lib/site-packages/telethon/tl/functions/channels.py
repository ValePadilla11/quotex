...
class ClickSponsoredMessageRequest(TLRequest):
    CONSTRUCTOR_ID = 0x1445d75
    SUBCLASS_OF_ID = 0xf5b399ac

    def __init__(self, channel: 'TypeInputChannel', media: Optional[bool]=None, fullscreen: Optional[bool]=None, random_id: bytes=None):
        """
        :returns Bool: This type has no constructors.
        """
        self.channel = channel
    ...
    def from_reader(cls, reader):
        ...
        return cls(channel=_channel, media=_media, fullscreen=_fullscreen, random_id=_random_id)
